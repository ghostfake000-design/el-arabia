...
export const COLORS = { primary: '#facc15', secondary: '#1e3a8a', accent: '#fde047', danger: '#ef4444', bgDark: '#0a0f1d', bgCard: '#161e31' };
export interface MenuItem { id: string; label: string; icon: React.ReactNode; permission: AppPermission }
...
export const INITIAL_UNITS = [ { id: '1', name: 'كيلو' }, { id: '2', name: 'قطعة' }, { id: '3', name: 'طن' } ];
export const INITIAL_WAREHOUSES = [ { id: '1', name: 'مخزن الإنتاج' }, { id: '2', name: 'مخزن الخردة' } ];
export const INITIAL_SUPPLIERS = [ { id: '1', name: 'شركة النصر للمسبوكات', phone: '01012345678', address: 'القاهرة، مدينة نصر' } ];
export const INITIAL_EMPLOYEES = [ { id: '1', name: 'أحمد جمال' }, { id: '2', name: 'ياسر محمود' } ];
